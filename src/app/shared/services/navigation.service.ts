...
//         { name: 'Sheet Metal JobCard', state: 'canopy-process/sheet-metal-jobcard' },
//         { name: 'sheet Metal JobCard Checker', state: 'canopy-process/sheet-metal-jobcard-checker' },
//         { name: 'cnc-maker', state: 'canopy-process/cnc-maker' },
//         { name: 'cnc-checker', state: 'canopy-process/cnc-checker' },
//         { name: 'bending-maker', state: 'canopy-process/bending-maker' },
//         { name: 'bending-checker', state: 'canopy-process/bending-checker' },
//         { name: 'fabrication-maker', state: 'canopy-process/fabrication-maker' },
//         { name: 'fabrication-checker', state: 'canopy-process/fabrication-checker' },
//         { name: 'powder coating maker', state: 'canopy-process/powder-coating-maker' },
//         { name: 'powder coating checker', state: 'canopy-process/powder-coating-checker' },
//         { name: 'Job Card Canopy Req InActive', state: 'canopy-process/job-card-conopy-req-in-active' },
//         { name: 'Sheet Metal Reverse Process', state: 'canopy-process/sheet-metal-reverse-process' }
//         // Add more items here if needed in future
//       ],
//     }
...
export class NavigationService {
  ...
  private currentLoginType: string | null = null;
  ...
  private buildUserMenu(response: ApiMenuResponse[]): IMenuItem[] {
    ...
    const sectionOrder = ['M', 'P', 'T', 'R', 'A', 'C1', 'C2', 'C3', 'C4', 'C5', 'CFT', 'COM'];
    const dynamicMenus: IMenuItem[] = [];
